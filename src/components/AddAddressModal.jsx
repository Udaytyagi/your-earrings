...
import { addAddress } from '../features/slices/addresses/addressSlice';

const AddAddressModal = ({ isPopupOpen, closePopup }) => {
    ...
    const handleAddAddress = (e) => {
        e.preventDefault();
        isMobileValid && isPinCodeValid && dispatch(addAddress({ data: formData, setLoading: setLoading, closePopup: closePopup }));
    };
                        ...
                        <section className="col-sm-12 profile-right" id="prfolie-right-5">
                            <div className="row">
                                <div className="col-md-12">
                                    <h5>Add Address <i className="fa-solid fa-plus-circle" /></h5>
